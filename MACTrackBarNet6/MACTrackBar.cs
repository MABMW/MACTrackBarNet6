...
namespace XComponent.SliderBar
{
	...
	public class MACTrackBar : System.Windows.Forms.Control
	{
		...
		private Color _trackLineSelectedColor = SystemColors.Control;
		...
		public MACTrackBar()
		{
			...
			_trackLineSelectedColor = Color.FromArgb(90, 93, 90);
			_trackLineHeight = 3;
		...
		/// <value>A <see cref="Color"/> object that represents the color of the track line.</value>
		[Category("Appearance")]
		[Description("Gets or sets the color of the track selected line.")]
		public Color TrackLineSelectedColor
		{
			get { return _trackLineSelectedColor; }
			set
			{
				if (value != _trackLineSelectedColor)
				{
					_trackLineSelectedColor = value;
					Invalidate();
				}
			}
		}
		...
		protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		{
			...
			if (_orientation == Orientation.Horizontal)
			{
				...
				// Draw the Track Line
				//==========================================================================
				drawRect = new RectangleF(workingRect.Left, currentUsedPos + _trackerSize.Height / 2 - _trackLineHeight / 2, _trackerRect.Left - workingRect.Left, _trackLineHeight);
				DrawTrackLine(e.Graphics, drawRect, _trackLineSelectedColor);
				drawRect = new RectangleF(_trackerRect.Right, currentUsedPos + _trackerSize.Height / 2 - _trackLineHeight / 2, workingRect.Width - _trackerRect.Right, _trackLineHeight);
			...
			else //_orientation == Orientation.Vertical
			{
				...
				drawRect = new RectangleF(currentUsedPos + _trackerSize.Height / 2 - _trackLineHeight / 2, workingRect.Top, _trackLineHeight, _trackerRect.Top - workingRect.Top);
				DrawTrackLine(e.Graphics, drawRect, _trackLineColor);
				drawRect = new RectangleF(currentUsedPos + _trackerSize.Height / 2 - _trackLineHeight / 2, _trackerRect.Bottom, _trackLineHeight, workingRect.Bottom - _trackerRect.Bottom);
				DrawTrackLine(e.Graphics, drawRect, _trackLineSelectedColor);
